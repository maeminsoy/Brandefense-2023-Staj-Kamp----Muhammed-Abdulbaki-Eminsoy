...
client_id = "client ID'inizi giriniz: "
client_secret = "client secret'inizi giriniz: "
user_agent = "user agent'inizi giriniiz: "
username = "Reddit username'inizi giriniz: "
password = "Reddit password'unuzu giriniz: "
...
for post in posts:
    ...
    # post_id'ye göre database olup olmadığına kontrol ediyoruz
